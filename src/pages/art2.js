	...
	return (
		<div>
			<div style={{maxWidth: '90%', paddingLeft: '5%', paddingBottom: '1em', top: '-1em', position: 'relative'}}>
				...
				<p>
					There were 3 problems in the shortlisting test. One of them (3rd one) was difficult for me. The other two was of medium difficulty.
				</p>
				<p>
				...
				<h3>How important was your CV? Would you advise adding things which are not completely true in CV?</h3>
				<p>
				...
				<h3>Duration of intern?</h3>
				<p>
					8 weeks
				</p>
				<h3>Who was your point of contact during your internship?</h3>
				<p>
					My manager was a KGP alumni himself, from my department. He always boosted my confidence and guided me throughout the internship.
				</p>
				<p>
					Also, my mentor was extremely helpful and he spoke to me on a regular basis. I did enjoy every moment with the team.
				</p>
				<h3>What was the main project or objective during your intern?</h3>
				<p>
					I worked at Salesforce's Health Cloud. My project was to build an application that aimed to recognize, analyse and store data automatically, directly from medical voice conversations.
				</p>
				<p>
					During the internship, I developed a prototype app for healthcare registrars that mitigated their role in registering, updating or fetching patient details, using the NLP domain of automating storage of patient interactions. I can't provide details to my work as it is confidential.
				</p>
				<h3>How was the work culture in the company?</h3>
				<p>
					Salesforce has one the best work cultures in the world. At the time of writing (2021), it was the 2nd best company in the world to work for according to <a href='https://fortune.com/best-companies/2021'>Fortune</a>.
				</p>
				<p>
					I worked for about 5 hours a day on average. They provided everything I needed for the internship, along with awesome gifts and swags on regular intervals. The employees are always happy, motivated and ready to clear all your doubts and everyone in the company was just a ping on Slack away.
				</p>
				...
				<h3>Anything you had to learn before the start of intern?</h3>
				<p>
